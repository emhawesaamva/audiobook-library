...
export default function HoldModal({ book, editing = false, suggestWeeks = null, willAdd = false, onSave, onClear, onClose }) {
  ...
  return (
    <Dialog title={editing ? "Edit hold" : "Did you put this book on hold?"} onClose={onClose}>
      ...
      {suggestWeeks != null && !existing && (
        <p className="mb-3 text-xs text-zinc-500 dark:text-zinc-400">
          Libby reported roughly this wait — adjust it if the hold screen said otherwise.
        </p>
      )}

      <label className={labelCls} htmlFor="hold-weeks">About how many weeks&rsquo; wait?</label>
